function initengahan(){
  ...
  function otomatis(){pesan3.style="transition:none";kalimat.style="opacity:0";if(otoaktipesan==0){setTimeout(otolanj,400)}}
  ...
  function aktipesan4(){
    wallpaper.style="transform: scale(1.5);";kalimat.innerHTML= "Sabar yaa " + nama + " :)";kalimat.style="transform:scale(1.2)";setTimeout(aktipesan5,1000);
  }
  ...
  ftganti=4;ftmuncul();
  new TypeIt("#pesan8", {
  strings: ["" + vketik8, ""], startDelay: 20, speed: 45, cursor: true, deleteSpeed: 30, breakLines: false, waitUntilVisible: true, lifelike: true,
  afterComplete: function(){
    setTimeout(otomatis,1300);setTimeout(aktipesan10,1310);
  },}).go();
  }
